...
//        clusterConfig.clusterNode("192.168.1.10", 8021);
//        clusterConfig.clusterNode("192.168.1.11", 8021);
//        clusterConfig.clusterNode("192.168.1.12", 8021);
//        clusterConfig.clusterNode("192.168.1.10", 8022);
//        clusterConfig.clusterNode("192.168.1.11", 8022);
//        clusterConfig.clusterNode("192.168.1.12", 8021);
//        clusterConfig.clusterNode("192.168.1.10", 8023);
//        clusterConfig.clusterNode("192.168.1.11", 8023);
//        clusterConfig.clusterNode("192.168.1.12", 8023);
