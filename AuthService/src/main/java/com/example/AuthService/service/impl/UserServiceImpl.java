...
import com.example.AuthService.exception.ErrorException;
...
//                outDTO.setCode(Const.RESPONSE_CODE.EMAIL_INVALID);
//                outDTO.setMessage(Const.RESPONSE_MESSAGE.EMAIL_INVALID);
//                return outDTO;
//            }
//            if (!isPasswordStrong(password, userName, email)) {
//                outDTO.setCode(Const.RESPONSE_CODE.PASSWORD_WEAK);
//                outDTO.setMessage(Const.RESPONSE_MESSAGE.PASSWORD_WEAK);
//                return outDTO;
//            }
//
//            if (findUserByEmail(email, Const.Status.ACTIVE.name()) != null) {
//                outDTO.setCode(Const.RESPONSE_CODE.EMAIL_EXISTED);
//                outDTO.setMessage(Const.RESPONSE_MESSAGE.EMAIL_EXISTED);
//                return outDTO;
//            }
//
...
//
//            outDTO.setCode(Const.RESPONSE_CODE.CREATED);
//            outDTO.setMessage(Const.RESPONSE_MESSAGE.SIGN_UP_SUCCESS);
        } catch (Exception e) {
            outDTO.setCode(Const.RESPONSE_CODE.ERROR);
            outDTO.setMessage(Const.RESPONSE_MESSAGE.ERROR);
            return outDTO;
